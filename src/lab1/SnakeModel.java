...
public class SnakeModel extends GameModel {
	...
	Color colorCafe = new Color (111,78,55);
	...
	private static final GameTile SNAKE_TILE = new RectangularTile(Color.colorCafe);

	/** Graphical representation of the snake's head */
	private static final GameTile SNAKE_HEAD_TILE = new RectangularTile(Color.colorCafe);
